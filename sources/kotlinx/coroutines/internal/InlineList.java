...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m264boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <E> Object m265constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m267equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m273unboximpl());
    }
    ...
    public static int m270hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m267equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m270hashCodeimpl(this.holder);
    }

    public String toString() {
        return m272toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m266constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m265constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM  reason: not valid java name */
    public static final Object m271plusFjFbRPM(Object arg0, E element) {
        if (DebugKt.getASSERTIONS_ENABLED() && ((element instanceof List) ^ 1) == 0) {
            throw new AssertionError();
        } else if (arg0 == null) {
            return m265constructorimpl(element);
        } else {
            if (!(arg0 instanceof ArrayList)) {
                ArrayList list = new ArrayList(4);
                list.add(arg0);
                list.add(element);
                return m265constructorimpl(list);
            } else if (arg0 != null) {
    ...
    public static final void m269forEachReversedimpl(Object arg0, Function1<? super E, Unit> action) {
        if (arg0 != null) {
            if (!(arg0 instanceof ArrayList)) {
                action.invoke(arg0);
            } else if (arg0 != null) {
