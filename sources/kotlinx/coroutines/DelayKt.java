...
public final class DelayKt {
    ...
    public static final Object m208delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m209toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m209toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m43compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m146getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m62getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
