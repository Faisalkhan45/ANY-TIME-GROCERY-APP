...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
        ...
        while (true) {
            ...
            while (true) {
                if (cur$iv$iv.getId() >= id$iv && !cur$iv$iv.getRemoved()) {
                    obj = SegmentOrClosed.m275constructorimpl(cur$iv$iv);
                    curTail = next$iv$iv;
                    break;
                }
                ...
                if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m275constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            s$iv = obj;
            if (SegmentOrClosed.m280isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m278getSegmentimpl(s$iv);
            while (true) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m278getSegmentimpl(s$iv);
        int i = (int) (enqIdx2 % ((long) SemaphoreKt.SEGMENT_SIZE));
        if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(segment.acquirers, i, (Object) null, cancellableContinuation)) {
            cancellableContinuation.invokeOnCancellation(new CancelSemaphoreAcquisitionHandler(segment, i));
            return true;
        }
        if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(segment.acquirers, i, SemaphoreKt.PERMIT, SemaphoreKt.TAKEN)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x001c:
            ...
            goto L_0x0030
        L_0x002b:
            java.lang.Object r11 = kotlinx.coroutines.internal.SegmentOrClosed.m275constructorimpl(r10)
            goto L_0x004a
        L_0x0030:
            r11 = r10
            ...
            java.lang.Object r16 = kotlinx.coroutines.internal.SegmentOrClosed.m275constructorimpl(r16)
            r11 = r16
        L_0x004a:
            r8 = r11
            boolean r9 = kotlinx.coroutines.internal.SegmentOrClosed.m280isClosedimpl(r8)
            if (r9 != 0) goto L_0x0096
            kotlinx.coroutines.internal.Segment r9 = kotlinx.coroutines.internal.SegmentOrClosed.m278getSegmentimpl(r8)
            r12 = r6
            r13 = 0
            r14 = r12
            r15 = 0
        ...
        L_0x0094:
            goto L_0x0059
        L_0x0096:
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m278getSegmentimpl(r8)
        ...
        L_0x00df:
            ...
            boolean r9 = com.google.common.util.concurrent.Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(r13, r7, r9, r10)
            r10 = 1
            r9 = r9 ^ r10
            return r9
        L_0x00f2:
