...
public final class GlideBuilder {
    ...
    public GlideBuilder useLifecycleInsteadOfInjectingFragments(boolean isEnabled) {
        this.glideExperimentsBuilder.update(new UseLifecycleInsteadOfInjectingFragments(), isEnabled);
        return this;
    }
    ...
    public Glide build(Context context, List<GlideModule> manifestModules, AppGlideModule annotationGeneratedGlideModule) {
        ...
        return new Glide(context, this.engine, this.memoryCache, this.bitmapPool, this.arrayPool, new RequestManagerRetriever(this.requestManagerFactory, experiments), this.connectivityMonitorFactory, this.logLevel, this.defaultRequestOptionsFactory, this.defaultTransitionOptions, this.defaultRequestListeners, manifestModules, annotationGeneratedGlideModule, experiments);
    }
