...
public class Query {
    ...
    private List<FieldFilter.Operator> conflictingOps(FieldFilter.Operator op) {
        switch (AnonymousClass1.$SwitchMap$com$google$firebase$firestore$core$FieldFilter$Operator[op.ordinal()]) {
            case 1:
    ...
    public Task<QuerySnapshot> get(Source source) {
        ...
        if (source == Source.CACHE) {
            return this.firestore.getClient().getDocumentsFromLocalCache(this.query).continueWith(Executors.DIRECT_EXECUTOR, new Query$$ExternalSyntheticLambda1(this));
        }
    ...
    public /* synthetic */ QuerySnapshot m311lambda$get$0$comgooglefirebasefirestoreQuery(Task viewSnap) throws Exception {
    ...
    private Task<QuerySnapshot> getViaSnapshotListener(Source source) {
        ...
        registration.setResult(addSnapshotListenerInternal(Executors.DIRECT_EXECUTOR, options, (Activity) null, new Query$$ExternalSyntheticLambda0(res, registration, source)));
        return res.getTask();
    }
    ...
    public /* synthetic */ void m310lambda$addSnapshotListenerInternal$2$comgooglefirebasefirestoreQuery(EventListener userListener, ViewSnapshot snapshot, FirebaseFirestoreException error) {
        if (error != null) {
