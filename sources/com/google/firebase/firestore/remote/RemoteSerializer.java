...
public final class RemoteSerializer {
    ...
    public Mutation decodeMutation(Write mutation) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$Write$OperationCase[mutation.getOperationCase().ordinal()]) {
            case 1:
    ...
    private com.google.firebase.firestore.model.mutation.Precondition decodePrecondition(com.google.firestore.v1.Precondition precondition) {
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$Precondition$ConditionTypeCase[precondition.getConditionTypeCase().ordinal()]) {
            case 1:
    ...
    private FieldTransform decodeFieldTransform(DocumentTransform.FieldTransform fieldTransform) {
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$DocumentTransform$FieldTransform$TransformTypeCase[fieldTransform.getTransformTypeCase().ordinal()]) {
            case 1:
    ...
    private String encodeLabel(QueryPurpose purpose) {
        switch (AnonymousClass1.$SwitchMap$com$google$firebase$firestore$local$QueryPurpose[purpose.ordinal()]) {
            case 1:
                return null;
            case 2:
    ...
    public com.google.firebase.firestore.core.Target decodeQueryTarget(java.lang.String r23, com.google.firestore.v1.StructuredQuery r24) {
        /*
            r22 = this;
            r0 = r22
            r1 = r24
    ...
    public StructuredQuery.CompositeFilter.Operator encodeCompositeFilterOperator(CompositeFilter.Operator op) {
        switch (AnonymousClass1.$SwitchMap$com$google$firebase$firestore$core$CompositeFilter$Operator[op.ordinal()]) {
            case 1:
    ...
    public CompositeFilter.Operator decodeCompositeFilterOperator(StructuredQuery.CompositeFilter.Operator op) {
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$StructuredQuery$CompositeFilter$Operator[op.ordinal()]) {
            case 1:
    ...
    public Filter decodeFilter(StructuredQuery.Filter proto) {
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$StructuredQuery$Filter$FilterTypeCase[proto.getFilterTypeCase().ordinal()]) {
            case 1:
    ...
    private Filter decodeUnaryFilter(StructuredQuery.UnaryFilter proto) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$StructuredQuery$UnaryFilter$Operator[proto.getOp().ordinal()]) {
            case 1:
    ...
    private OrderBy decodeOrderBy(StructuredQuery.Order proto) {
        ...
        FieldPath fieldPath = FieldPath.fromServerFormat(proto.getField().getFieldPath());
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$StructuredQuery$Direction[proto.getDirection().ordinal()]) {
            case 1:
    ...
    public WatchChange decodeWatchChange(ListenResponse protoChange) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$ListenResponse$ResponseTypeCase[protoChange.getResponseTypeCase().ordinal()]) {
            case 1:
                TargetChange targetChange = protoChange.getTargetChange();
                Status cause = null;
                switch (AnonymousClass1.$SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType[targetChange.getTargetChangeType().ordinal()]) {
                    case 1:
