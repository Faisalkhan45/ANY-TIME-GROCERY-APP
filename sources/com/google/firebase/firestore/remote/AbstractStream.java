...
abstract class AbstractStream<ReqT, RespT, CallbackT extends Stream.StreamCallback> implements Stream<CallbackT> {
    ...
    class StreamObserver implements IncomingStreamObserver<RespT> {
        ...
        public void onHeaders(Metadata headers) {
            this.dispatcher.run(new AbstractStream$StreamObserver$$ExternalSyntheticLambda3(this, headers));
        }
        ...
        public /* synthetic */ void m406lambda$onHeaders$0$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver(Metadata headers) {
        ...
        public void onNext(RespT response) {
            this.dispatcher.run(new AbstractStream$StreamObserver$$ExternalSyntheticLambda2(this, response));
        }
        ...
        public /* synthetic */ void m407lambda$onNext$1$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver(Object response) {
            if (Logger.isDebugEnabled()) {
        ...
        public /* synthetic */ void m408lambda$onOpen$2$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver() {
        ...
        public /* synthetic */ void m405lambda$onClose$3$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver(Status status) {
            if (status.isOk()) {
    ...
    public /* synthetic */ void m403lambda$onOpen$0$comgooglefirebasefirestoreremoteAbstractStream() {
        if (isOpen()) {
    ...
    public /* synthetic */ void m404lambda$performBackoff$1$comgooglefirebasefirestoreremoteAbstractStream() {
