...
public class FirestoreChannel {
    ...
    public /* synthetic */ void m413lambda$runBidiStreamingRpc$0$comgooglefirebasefirestoreremoteFirestoreChannel(final ClientCall[] call, final IncomingStreamObserver observer, Task result) {
    ...
    public <ReqT, RespT> void runStreamingResponseRpc(MethodDescriptor<ReqT, RespT> method, ReqT request, StreamingListener<RespT> callback) {
        this.callProvider.createClientCall(method).addOnCompleteListener(this.asyncQueue.getExecutor(), new FirestoreChannel$$ExternalSyntheticLambda0(this, callback, request));
    }
    ...
    public /* synthetic */ void m415lambda$runStreamingResponseRpc$1$comgooglefirebasefirestoreremoteFirestoreChannel(final StreamingListener callback, Object request, Task result) {
    ...
    public /* synthetic */ void m414lambda$runRpc$2$comgooglefirebasefirestoreremoteFirestoreChannel(final TaskCompletionSource tcs, Object request, Task result) {
