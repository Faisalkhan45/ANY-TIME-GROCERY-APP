...
public class Util {
    ...
    public static void crashMainThread(RuntimeException exception) {
        new Handler(Looper.getMainLooper()).post(new Util$$ExternalSyntheticLambda1(exception));
    }
    ...
    public static <T extends Comparable<T>> void diffCollections(SortedSet<T> before, SortedSet<T> after, Consumer<T> onAdd, Consumer<T> onRemove) {
        ...
        if (before.comparator() != null) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0016: CONSTRUCTOR  (r2v2 ? I:com.google.firebase.firestore.util.Util$$ExternalSyntheticLambda4) =  call: com.google.firebase.firestore.util.Util$$ExternalSyntheticLambda4.<init>():void type: CONSTRUCTOR in method: com.google.firebase.firestore.util.Util.diffCollections(java.util.SortedSet, java.util.SortedSet, com.google.firebase.firestore.util.Consumer, com.google.firebase.firestore.util.Consumer):void, dex: classes8.dex
        ...
        public static <K, V> Iterable<V> values(Iterable<Map.Entry<K, V>> map) {
            return new Util$$ExternalSyntheticLambda0(map);
        }
        ...
        public static <K, V> Map<K, V> firstNEntries(Map<K, V> data, int n, Comparator<V> comp) {
            ...
            Collections.sort(sortedValues, new Util$$ExternalSyntheticLambda5(comp));
