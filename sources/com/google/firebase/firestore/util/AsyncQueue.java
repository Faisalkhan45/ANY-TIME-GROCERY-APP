...
public class AsyncQueue {
    ...
    private class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        public /* synthetic */ void m428lambda$new$0$comgooglefirebasefirestoreutilAsyncQueue$SynchronizedShutdownAwareExecutor(Thread crashingThread, Throwable throwable) {
        ...
        public synchronized Task<Void> executeAndInitiateShutdown(Runnable task) {
            ...
            Task<Void> t = executeAndReportResult(new AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1(task));
    ...
    public Task<Void> enqueue(Runnable task) {
        return enqueue(new AsyncQueue$$ExternalSyntheticLambda0(task));
    }
    ...
    public void panic(Throwable t) {
        ...
        new Handler(Looper.getMainLooper()).post(new AsyncQueue$$ExternalSyntheticLambda6(t));
    }

    static /* synthetic */ void lambda$panic$3(Throwable t) {
        if (t instanceof OutOfMemoryError) {
            OutOfMemoryError error = new OutOfMemoryError("Firestore (24.4.1) ran out of memory. Check your queries to make sure they are not loading an excessive amount of data.");
            error.initCause(t);
            throw error;
        }
        throw new RuntimeException("Internal error in Cloud Firestore (24.4.1).", t);
    }
    ...
    public void runDelayedTasksUntil(TimerId lastTimerId) throws InterruptedException {
        runSync(new AsyncQueue$$ExternalSyntheticLambda3(this, lastTimerId));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runDelayedTasksUntil$6$com-google-firebase-firestore-util-AsyncQueue  reason: not valid java name */
    public /* synthetic */ void m427lambda$runDelayedTasksUntil$6$comgooglefirebasefirestoreutilAsyncQueue(TimerId lastTimerId) {
