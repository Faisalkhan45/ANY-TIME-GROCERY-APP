...
public class LoadBundleTask extends Task<LoadBundleTaskProgress> {
    ...
    public void m308lambda$addOnProgressListener$0$comgooglefirebasefirestoreLoadBundleTask(OnProgressListener<LoadBundleTaskProgress> listener) {
        synchronized (this.lock) {
    ...
    private static class ManagedListener {
        ...
        public /* synthetic */ void m309lambda$invokeAsync$0$comgooglefirebasefirestoreLoadBundleTask$ManagedListener(LoadBundleTaskProgress snapshot) {
