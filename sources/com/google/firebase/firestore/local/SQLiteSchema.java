...
class SQLiteSchema {
    ...
    private void createV1MutationQueue() {
        ifTablesDontExist(new String[]{"mutation_queues", "mutations", "document_mutations"}, new SQLiteSchema$$ExternalSyntheticLambda3(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$createV1MutationQueue$0$com-google-firebase-firestore-local-SQLiteSchema  reason: not valid java name */
    public /* synthetic */ void m391lambda$createV1MutationQueue$0$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    private void removeAcknowledgedMutations() {
        new SQLitePersistence.Query(this.db, "SELECT uid, last_acknowledged_batch_id FROM mutation_queues").forEach(new SQLiteSchema$$ExternalSyntheticLambda15(this));
    }
    ...
    public /* synthetic */ void m397lambda$removeAcknowledgedMutations$2$comgooglefirebasefirestorelocalSQLiteSchema(Cursor mutationQueueEntry) {
        String uid = mutationQueueEntry.getString(0);
        long lastAcknowledgedBatchId = mutationQueueEntry.getLong(1);
        new SQLitePersistence.Query(this.db, "SELECT batch_id FROM mutations WHERE uid = ? AND batch_id <= ?").binding(uid, Long.valueOf(lastAcknowledgedBatchId)).forEach(new SQLiteSchema$$ExternalSyntheticLambda0(this, uid));
    }
    ...
    public /* synthetic */ void m396lambda$removeAcknowledgedMutations$1$comgooglefirebasefirestorelocalSQLiteSchema(String uid, Cursor value) {
    ...
    public /* synthetic */ void m393lambda$createV1TargetCache$3$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    private void createV1RemoteDocumentCache() {
        ifTablesDontExist(new String[]{"remote_documents"}, new SQLiteSchema$$ExternalSyntheticLambda14(this));
    }
    ...
    public /* synthetic */ void m392lambda$createV1RemoteDocumentCache$4$comgooglefirebasefirestorelocalSQLiteSchema() {
        this.db.execSQL("CREATE TABLE remote_documents (path TEXT PRIMARY KEY, contents BLOB)");
    }

    private void createFieldIndex() {
        ifTablesDontExist(new String[]{"index_configuration", "index_state", "index_entries"}, new SQLiteSchema$$ExternalSyntheticLambda13(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$createFieldIndex$5$com-google-firebase-firestore-local-SQLiteSchema  reason: not valid java name */
    public /* synthetic */ void m389lambda$createFieldIndex$5$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    private void dropLastLimboFreeSnapshotVersion() {
        new SQLitePersistence.Query(this.db, "SELECT target_id, target_proto FROM targets").forEach(new SQLiteSchema$$ExternalSyntheticLambda17(this));
    }
    ...
    public /* synthetic */ void m395lambda$dropLastLimboFreeSnapshotVersion$6$comgooglefirebasefirestorelocalSQLiteSchema(Cursor cursor) {
        ...
        try {
            ...
            this.db.execSQL("UPDATE targets SET target_proto = ? WHERE target_id = ?", new Object[]{targetProto.toByteArray(), Integer.valueOf(targetId)});
    ...
    private void ensureSequenceNumbers() {
        Long boxedSequenceNumber = (Long) new SQLitePersistence.Query(this.db, "SELECT highest_listen_sequence_number FROM target_globals LIMIT 1").firstValue(new SQLiteSchema$$ExternalSyntheticLambda1());
        ...
        do {
            ...
            untaggedDocumentsQuery.forEach(new SQLiteSchema$$ExternalSyntheticLambda2(resultsRemaining, tagDocument, sequenceNumber));
    ...
    private void createV8CollectionParentsIndex() {
        ifTablesDontExist(new String[]{"collection_parents"}, new SQLiteSchema$$ExternalSyntheticLambda4(this));
        Consumer<ResourcePath> addEntry = new SQLiteSchema$$ExternalSyntheticLambda5(new MemoryIndexManager.MemoryCollectionParentIndex(), this.db.compileStatement("INSERT OR REPLACE INTO collection_parents (collection_id, parent) VALUES (?, ?)"));
        new SQLitePersistence.Query(this.db, "SELECT path FROM remote_documents").forEach(new SQLiteSchema$$ExternalSyntheticLambda6(addEntry));
        new SQLitePersistence.Query(this.db, "SELECT path FROM document_mutations").forEach(new SQLiteSchema$$ExternalSyntheticLambda7(addEntry));
    }
    ...
    public /* synthetic */ void m394lambda$createV8CollectionParentsIndex$9$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    private void rewriteCanonicalIds() {
        new SQLitePersistence.Query(this.db, "SELECT target_id, target_proto FROM targets").forEach(new SQLiteSchema$$ExternalSyntheticLambda10(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$rewriteCanonicalIds$13$com-google-firebase-firestore-local-SQLiteSchema  reason: not valid java name */
    public /* synthetic */ void m398lambda$rewriteCanonicalIds$13$comgooglefirebasefirestorelocalSQLiteSchema(Cursor cursor) {
        int targetId = cursor.getInt(0);
        try {
    ...
    private void ensurePathLength() {
        ...
        do {
            resultsRemaining[0] = false;
            documentsToMigrate.forEach(new SQLiteSchema$$ExternalSyntheticLambda8(resultsRemaining, insertKey));
        } while (resultsRemaining[0]);
    }
    ...
    private void createBundleCache() {
        ifTablesDontExist(new String[]{"bundles", "named_queries"}, new SQLiteSchema$$ExternalSyntheticLambda16(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$createBundleCache$15$com-google-firebase-firestore-local-SQLiteSchema  reason: not valid java name */
    public /* synthetic */ void m387lambda$createBundleCache$15$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    private void createOverlays() {
        ifTablesDontExist(new String[]{"document_overlays"}, new SQLiteSchema$$ExternalSyntheticLambda12(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$createOverlays$16$com-google-firebase-firestore-local-SQLiteSchema  reason: not valid java name */
    public /* synthetic */ void m390lambda$createOverlays$16$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    private void createDataMigrationTable() {
        ifTablesDontExist(new String[]{"data_migrations"}, new SQLiteSchema$$ExternalSyntheticLambda11(this));
    }
    ...
    public /* synthetic */ void m388lambda$createDataMigrationTable$17$comgooglefirebasefirestorelocalSQLiteSchema() {
