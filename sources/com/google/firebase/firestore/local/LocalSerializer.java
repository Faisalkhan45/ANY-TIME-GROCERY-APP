...
public final class LocalSerializer {
    ...
    public MutableDocument decodeMaybeDocument(MaybeDocument proto) {
        switch (AnonymousClass1.$SwitchMap$com$google$firebase$firestore$proto$MaybeDocument$DocumentTypeCase[proto.getDocumentTypeCase().ordinal()]) {
            case 1:
    ...
    public TargetData decodeTargetData(Target targetProto) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase[targetProto.getTargetTypeCase().ordinal()]) {
            case 1:
