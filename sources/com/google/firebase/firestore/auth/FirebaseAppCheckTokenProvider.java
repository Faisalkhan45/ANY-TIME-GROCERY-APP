...
public final class FirebaseAppCheckTokenProvider extends CredentialsProvider<String> {
    ...
    public /* synthetic */ void m314lambda$new$1$comgooglefirebasefirestoreauthFirebaseAppCheckTokenProvider(Provider provider) {
        synchronized (this) {
    ...
    public synchronized void m313lambda$new$0$comgooglefirebasefirestoreauthFirebaseAppCheckTokenProvider(AppCheckTokenResult result) {
