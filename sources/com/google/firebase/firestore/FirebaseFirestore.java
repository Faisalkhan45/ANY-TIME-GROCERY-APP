...
public class FirebaseFirestore {
    ...
    static FirebaseFirestore newInstance(Context context2, FirebaseApp app, Deferred<InternalAuthProvider> deferredAuthProvider, Deferred<InternalAppCheckTokenProvider> deferredAppCheckTokenProvider, String database, InstanceRegistry instanceRegistry2, GrpcMetadataProvider metadataProvider2) {
        String projectId = app.getOptions().getProjectId();
        if (projectId != null) {
            DatabaseId databaseId2 = DatabaseId.forDatabase(projectId, database);
            AsyncQueue queue = new AsyncQueue();
            return new FirebaseFirestore(context2, databaseId2, app.getName(), new FirebaseAuthCredentialsProvider(deferredAuthProvider), new FirebaseAppCheckTokenProvider(deferredAppCheckTokenProvider), queue, app, instanceRegistry2, metadataProvider2);
        }
    ...
    private <ResultT> Task<ResultT> runTransaction(TransactionOptions options, Transaction.Function<ResultT> updateFunction, Executor executor) {
        ensureClientConfigured();
        return this.client.transaction(options, new FirebaseFirestore$$ExternalSyntheticLambda1(this, executor, updateFunction));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runTransaction$1$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ Task m307lambda$runTransaction$1$comgooglefirebasefirestoreFirebaseFirestore(Executor executor, Transaction.Function updateFunction, com.google.firebase.firestore.core.Transaction internalTransaction) {
        return Tasks.call(executor, new FirebaseFirestore$$ExternalSyntheticLambda0(this, updateFunction, internalTransaction));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runTransaction$0$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ Object m306lambda$runTransaction$0$comgooglefirebasefirestoreFirebaseFirestore(Transaction.Function updateFunction, com.google.firebase.firestore.core.Transaction internalTransaction) throws Exception {
    ...
    public /* synthetic */ void m304lambda$clearPersistence$2$comgooglefirebasefirestoreFirebaseFirestore(TaskCompletionSource source) {
        try {
            if (this.client != null) {
    ...
    public Task<Query> getNamedQuery(String name) {
        ensureClientConfigured();
        return this.client.getNamedQuery(name).continueWith(new FirebaseFirestore$$ExternalSyntheticLambda5(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getNamedQuery$3$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ Query m305lambda$getNamedQuery$3$comgooglefirebasefirestoreFirebaseFirestore(Task task) throws Exception {
    ...
    private ListenerRegistration addSnapshotsInSyncListener(Executor userExecutor, Activity activity, Runnable runnable) {
        ensureClientConfigured();
        AsyncEventListener<Void> asyncListener = new AsyncEventListener<>(userExecutor, new FirebaseFirestore$$ExternalSyntheticLambda2(runnable));
        this.client.addSnapshotsInSyncListener(asyncListener);
        return ActivityScope.bind(activity, new FirebaseFirestore$$ExternalSyntheticLambda3(this, asyncListener));
    }
    ...
    public /* synthetic */ void m303lambda$addSnapshotsInSyncListener$5$comgooglefirebasefirestoreFirebaseFirestore(AsyncEventListener asyncListener) {
        asyncListener.mute();
