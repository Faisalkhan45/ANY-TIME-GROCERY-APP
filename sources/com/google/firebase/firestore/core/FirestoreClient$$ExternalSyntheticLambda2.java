...
public final /* synthetic */ class FirestoreClient$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ FirestoreClient$$ExternalSyntheticLambda2(FirestoreClient firestoreClient, User user) {
        this.f$0 = firestoreClient;
        this.f$1 = user;
    }

    public final void run() {
        this.f$0.m329lambda$new$1$comgooglefirebasefirestorecoreFirestoreClient(this.f$1);
    }
}
