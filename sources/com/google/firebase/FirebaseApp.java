...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context applicationContext2, String name2, FirebaseOptions options2) {
        ...
        ComponentRuntime build = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(registrars).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.of(applicationContext2, Context.class, new Class[0])).addComponent(Component.of(this, FirebaseApp.class, new Class[0])).addComponent(Component.of(options2, FirebaseOptions.class, new Class[0])).setProcessor(new ComponentMonitor()).build();
    ...
    public /* synthetic */ DataCollectionConfigStorage m296lambda$new$0$comgooglefirebaseFirebaseApp(Context applicationContext2) {
    ...
    public /* synthetic */ void m297lambda$new$1$comgooglefirebaseFirebaseApp(boolean background) {
        if (!background) {
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context applicationContext2) {
            if (INSTANCE.get() == null) {
                ...
                if (zap$$ExternalSyntheticBackportWithForwarding0.m(INSTANCE, (Object) null, receiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (zap$$ExternalSyntheticBackportWithForwarding0.m(INSTANCE, (Object) null, listener)) {
