...
public final class zzxc {
    ...
    public static FirebaseException zza(Status status) {
        ...
        switch (statusCode) {
            ...
            case 18006:
                return new zzw(zzd(statusCode), zze);
            case 18011:
                return new zzv(zzd(statusCode), zze);
            default:
    ...
    public static FirebaseAuthMultiFactorException zzc(FirebaseAuth firebaseAuth, zztm zztm, FirebaseUser firebaseUser) {
        if (firebaseAuth == null) {
            ...
            List<MultiFactorInfo> zzc = zztm.zzc();
            ...
            return new FirebaseAuthMultiFactorException(str, str2, new zzae(arrayList, zzag.zzb(zztm.zzc(), zztm.zzb()), firebaseAuth.getApp().getName(), zztm.zza(), (zzx) firebaseUser));
        } else {
            throw null;
        }
    }
