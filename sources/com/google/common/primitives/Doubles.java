...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    private static Pattern fpPattern() {
        ...
        return Pattern.compile(new StringBuilder(String.valueOf(completeDec).length() + 23 + String.valueOf(completeHex).length()).append("[+-]?(?:NaN|Infinity|").append(completeDec).append("|").append(completeHex).append(")").toString().replace("#", "+"));
    }
