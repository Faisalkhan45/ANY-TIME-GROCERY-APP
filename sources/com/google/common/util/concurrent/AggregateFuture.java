...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    public /* synthetic */ void m293lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(ListenableFuture future, int index) {
        try {
            ...
            m294lambda$init$1$comgooglecommonutilconcurrentAggregateFuture((ImmutableCollection) null);
        }
    }
    ...
    public void m294lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion) {
