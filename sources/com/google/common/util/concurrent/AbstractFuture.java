    ...
    public static Object getFutureValue(ListenableFuture<?> future) {
        ...
        if (future instanceof Trusted) {
            ...
            try {
                ...
                return new Failure(new IllegalArgumentException(new StringBuilder(String.valueOf(valueOf3).length() + 77).append("get() threw CancellationException, despite reporting isCancelled() == false: ").append(valueOf3).toString(), cancellation2));
            } catch (Throwable t) {
