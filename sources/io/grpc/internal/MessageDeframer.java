...
public class MessageDeframer implements Closeable, Deframer {
    ...
    private void deliver() {
        if (!this.inDelivery) {
            ...
            while (!this.stopDelivery && this.pendingDeliveries > 0 && readRequiredBytes()) {
                try {
                    switch (AnonymousClass1.$SwitchMap$io$grpc$internal$MessageDeframer$State[this.state.ordinal()]) {
                        case 1:
                            processHeader();
                            break;
                        case 2:
    ...
    private void processBody() {
        ...
        this.nextFrame = null;
        this.listener.messagesAvailable(new SingleMessageProducer(stream, (AnonymousClass1) null));
    ...
    private static class SingleMessageProducer implements StreamListener.MessageProducer {
        ...
        /* synthetic */ SingleMessageProducer(InputStream x0, AnonymousClass1 x1) {
            this(x0);
        }
