    ...
    public void deframe(final ReadableBuffer data) {
        runWhereAppropriate(new Object() {
            /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
                io.grpc.internal.MigratingThreadDeframer.access$500(r3.this$0).deframeFailed(r1);
                io.grpc.internal.MigratingThreadDeframer.access$400(r3.this$0).close();
             */
            /* JADX WARNING: Code restructure failed: missing block: B:14:0x003c, code lost:
                io.perfmark.PerfMark.stopTask("MigratingThreadDeframer.deframe");
             */
            ...
            public void run(boolean r4) {
                /*
                    ...
                    io.grpc.internal.MigratingThreadDeframer r1 = io.grpc.internal.MigratingThreadDeframer.this     // Catch:{ all -> 0x0016 }
                ...
                L_0x0016:
                    ...
                    goto L_0x003c
                L_0x0018:
                    io.grpc.internal.MigratingThreadDeframer r1 = io.grpc.internal.MigratingThreadDeframer.this     // Catch:{ all -> 0x0024 }
                ...
                L_0x0024:
                    r1 = move-exception
                    io.grpc.internal.MigratingThreadDeframer r2 = io.grpc.internal.MigratingThreadDeframer.this     // Catch:{ all -> 0x0016 }
                ...
                L_0x003c:
                    ...
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.internal.MigratingThreadDeframer.AnonymousClass1DeframeOp.run(boolean):void");
            }
    ...
    class DeframeMessageProducer implements StreamListener.MessageProducer, Closeable {
        ...
        public void close() {
            ...
            L_0x0000:
                ...
                monitor-enter(r0)
            L_0x0007:
                io.grpc.internal.MigratingThreadDeframer r1 = io.grpc.internal.MigratingThreadDeframer.this     // Catch:{ all -> 0x002b }
                java.util.Queue r1 = r1.opQueue     // Catch:{ all -> 0x002b }
                java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x002b }
                io.grpc.internal.MigratingThreadDeframer$Op r1 = (io.grpc.internal.MigratingThreadDeframer.Op) r1     // Catch:{ all -> 0x002b }
                if (r1 == 0) goto L_0x0019
                boolean r2 = r1 instanceof java.io.Closeable     // Catch:{ all -> 0x002b }
                if (r2 == 0) goto L_0x0007
            L_0x0019:
                if (r1 != 0) goto L_0x0023
                io.grpc.internal.MigratingThreadDeframer r2 = io.grpc.internal.MigratingThreadDeframer.this     // Catch:{ all -> 0x002b }
                r3 = 0
