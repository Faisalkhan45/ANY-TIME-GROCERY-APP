...
public class Http2Ping {
    ...
    public void addCallback(io.grpc.internal.ClientTransport.PingCallback r3, java.util.concurrent.Executor r4) {
        ...
        L_0x000c:
            ...
            java.lang.Runnable r0 = asRunnable((io.grpc.internal.ClientTransport.PingCallback) r3, (java.lang.Throwable) r0)     // Catch:{ all -> 0x0021 }
            goto L_0x001b
        L_0x0015:
            long r0 = r2.roundTripTimeNanos     // Catch:{ all -> 0x0021 }
            java.lang.Runnable r0 = asRunnable((io.grpc.internal.ClientTransport.PingCallback) r3, (long) r0)     // Catch:{ all -> 0x0021 }
        L_0x001b:
            monitor-exit(r2)     // Catch:{ all -> 0x0021 }
            doExecute(r4, r0)
            return
