...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x0097, code lost:
        if ((r7 instanceof io.grpc.internal.RetriableStream.StartEntry) == false) goto L_0x009a;
     */
    ...
    private final class Sublistener implements ClientStreamListener {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void closed(final io.grpc.Status r8, final io.grpc.internal.ClientStreamListener.RpcProgress r9, final io.grpc.Metadata r10) {
            /*
                r7 = this;
                io.grpc.internal.RetriableStream r0 = io.grpc.internal.RetriableStream.this
                java.lang.Object r0 = r0.lock
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01f5 }
                io.grpc.internal.RetriableStream$State r2 = r1.state     // Catch:{ all -> 0x01f5 }
                io.grpc.internal.RetriableStream$Substream r3 = r7.substream     // Catch:{ all -> 0x01f5 }
                io.grpc.internal.RetriableStream$State r2 = r2.substreamClosed(r3)     // Catch:{ all -> 0x01f5 }
                io.grpc.internal.RetriableStream.State unused = r1.state = r2     // Catch:{ all -> 0x01f5 }
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01f5 }
                io.grpc.internal.InsightBuilder r1 = r1.closedSubstreamsInsight     // Catch:{ all -> 0x01f5 }
                io.grpc.Status$Code r2 = r8.getCode()     // Catch:{ all -> 0x01f5 }
            ...
            L_0x004c:
                ...
                io.grpc.StatusRuntimeException r1 = r8.asRuntimeException()
                io.grpc.Status r0 = r0.withCause(r1)
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this
                java.util.concurrent.Executor r1 = r1.listenerSerializeExecutor
            ...
            L_0x00e5:
                ...
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x011e }
                io.grpc.internal.RetriableStream$State r3 = r2.state     // Catch:{ all -> 0x011e }
                io.grpc.internal.RetriableStream$Substream r4 = r7.substream     // Catch:{ all -> 0x011e }
                io.grpc.internal.RetriableStream$State r3 = r3.removeActiveHedge(r4)     // Catch:{ all -> 0x011e }
                io.grpc.internal.RetriableStream.State unused = r2.state = r3     // Catch:{ all -> 0x011e }
                boolean r2 = r0.isHedgeable     // Catch:{ all -> 0x011e }
                if (r2 == 0) goto L_0x011b
                io.grpc.internal.RetriableStream r2 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x011e }
                io.grpc.internal.RetriableStream$State r3 = r2.state     // Catch:{ all -> 0x011e }
                boolean r2 = r2.hasPotentialHedging(r3)     // Catch:{ all -> 0x011e }
                if (r2 != 0) goto L_0x0119
                io.grpc.internal.RetriableStream r2 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x011e }
                io.grpc.internal.RetriableStream$State r2 = r2.state     // Catch:{ all -> 0x011e }
                java.util.Collection<io.grpc.internal.RetriableStream$Substream> r2 = r2.activeHedges     // Catch:{ all -> 0x011e }
            ...
            L_0x0121:
                ...
                java.lang.Object r1 = r1.lock
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0159 }
                io.grpc.internal.RetriableStream$FutureCanceller r3 = new io.grpc.internal.RetriableStream$FutureCanceller     // Catch:{ all -> 0x0159 }
                io.grpc.internal.RetriableStream r4 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0159 }
                java.lang.Object r4 = r4.lock     // Catch:{ all -> 0x0159 }
                r3.<init>(r4)     // Catch:{ all -> 0x0159 }
                r4 = r3
                io.grpc.internal.RetriableStream.FutureCanceller unused = r2.scheduledRetry = r3     // Catch:{ all -> 0x0159 }
            ...
            L_0x015c:
                ...
                monitor-enter(r3)
                io.grpc.internal.RetriableStream r4 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream$State r5 = r4.state     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream$Substream r6 = r7.substream     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream$State r5 = r5.replaceActiveHedge(r6, r0)     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream.State unused = r4.state = r5     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream r4 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream$State r5 = r4.state     // Catch:{ all -> 0x01aa }
                boolean r4 = r4.hasPotentialHedging(r5)     // Catch:{ all -> 0x01aa }
                if (r4 != 0) goto L_0x01a1
                io.grpc.internal.RetriableStream r4 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01aa }
                io.grpc.internal.RetriableStream$State r4 = r4.state     // Catch:{ all -> 0x01aa }
                java.util.Collection<io.grpc.internal.RetriableStream$Substream> r4 = r4.activeHedges     // Catch:{ all -> 0x01aa }
            ...
            L_0x01c4:
                ...
                io.grpc.internal.RetriableStream$Sublistener$4 r2 = new io.grpc.internal.RetriableStream$Sublistener$4
                r2.<init>(r0)
                r1.execute(r2)
                return
            L_0x01d3:
                ...
                io.grpc.internal.RetriableStream r0 = io.grpc.internal.RetriableStream.this
                java.util.concurrent.Executor r0 = r0.listenerSerializeExecutor
                io.grpc.internal.RetriableStream$Sublistener$5 r1 = new io.grpc.internal.RetriableStream$Sublistener$5
                r1.<init>(r8, r9, r10)
                r0.execute(r1)
            L_0x01f4:
                return
