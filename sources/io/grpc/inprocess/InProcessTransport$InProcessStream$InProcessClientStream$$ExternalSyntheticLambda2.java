...
public final /* synthetic */ class InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda2(InProcessTransport.InProcessStream.InProcessClientStream inProcessClientStream) {
        this.f$0 = inProcessClientStream;
    }

    public final void run() {
        this.f$0.m439lambda$halfClose$5$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream();
    }
}
