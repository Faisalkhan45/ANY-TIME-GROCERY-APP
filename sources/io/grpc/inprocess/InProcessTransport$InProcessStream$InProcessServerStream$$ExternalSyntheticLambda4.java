...
public final /* synthetic */ class InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda4(InProcessTransport.InProcessStream.InProcessServerStream inProcessServerStream, Status status) {
        this.f$0 = inProcessServerStream;
        this.f$1 = status;
    }

    public final void run() {
        this.f$0.m447lambda$internalCancel$6$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(this.f$1);
    }
}
