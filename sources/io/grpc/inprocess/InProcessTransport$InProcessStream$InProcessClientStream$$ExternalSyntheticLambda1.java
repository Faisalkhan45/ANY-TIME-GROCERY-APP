...
public final /* synthetic */ class InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda1(InProcessTransport.InProcessStream.InProcessClientStream inProcessClientStream, Status status) {
        this.f$0 = inProcessClientStream;
        this.f$1 = status;
    }

    public final void run() {
        this.f$0.m440lambda$internalCancel$4$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream(this.f$1);
    }
}
