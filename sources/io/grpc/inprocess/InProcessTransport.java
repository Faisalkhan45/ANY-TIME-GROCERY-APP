...
final class InProcessTransport implements ServerTransport, ConnectionClientTransport {
    ...
    private class InProcessStream {
        ...
        private class InProcessServerStream implements ServerStream {
            ...
            public void request(int numMessages) {
                if (InProcessStream.this.clientStream.serverRequested(numMessages)) {
                    synchronized (this) {
                        if (!this.closed) {
                            this.syncContext.executeLater(new InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda3(this));
                        }
                    }
                }
            ...
            public /* synthetic */ void m449lambda$request$0$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream() {
            ...
            public boolean clientRequested(int r8) {
                /*
                    r7 = this;
                    monitor-enter(r7)
                    boolean r0 = r7.closed     // Catch:{ all -> 0x0080 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0008
                    monitor-exit(r7)     // Catch:{ all -> 0x0080 }
                    return r1
                L_0x0008:
                    int r0 = r7.clientRequested     // Catch:{ all -> 0x0080 }
                    r2 = 1
                    if (r0 <= 0) goto L_0x000f
                    r3 = r2
                    goto L_0x0010
                ...
                L_0x0010:
                    int r0 = r0 + r8
                    r7.clientRequested = r0     // Catch:{ all -> 0x0080 }
                L_0x0013:
                    int r0 = r7.clientRequested     // Catch:{ all -> 0x0080 }
                    if (r0 <= 0) goto L_0x0037
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r0 = r7.clientReceiveQueue     // Catch:{ all -> 0x0080 }
                    ...
                    r7.clientRequested = r0     // Catch:{ all -> 0x0080 }
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r0 = r7.clientReceiveQueue     // Catch:{ all -> 0x0080 }
                    java.lang.Object r0 = r0.poll()     // Catch:{ all -> 0x0080 }
                    io.grpc.internal.StreamListener$MessageProducer r0 = (io.grpc.internal.StreamListener.MessageProducer) r0     // Catch:{ all -> 0x0080 }
                    io.grpc.SynchronizationContext r4 = r7.syncContext     // Catch:{ all -> 0x0080 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda1 r5 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda1     // Catch:{ all -> 0x0080 }
                    r5.<init>(r7, r0)     // Catch:{ all -> 0x0080 }
                    r4.executeLater(r5)     // Catch:{ all -> 0x0080 }
                    goto L_0x0013
                L_0x0037:
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r0 = r7.clientReceiveQueue     // Catch:{ all -> 0x0080 }
                    boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0080 }
                    if (r0 == 0) goto L_0x006d
                    io.grpc.Status r0 = r7.clientNotifyStatus     // Catch:{ all -> 0x0080 }
                    if (r0 == 0) goto L_0x006d
                    r7.closed = r2     // Catch:{ all -> 0x0080 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0080 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream r0 = r0.clientStream     // Catch:{ all -> 0x0080 }
                    io.grpc.internal.StatsTraceContext r0 = r0.statsTraceCtx     // Catch:{ all -> 0x0080 }
                    io.grpc.Metadata r4 = r7.clientNotifyTrailers     // Catch:{ all -> 0x0080 }
                    r0.clientInboundTrailers(r4)     // Catch:{ all -> 0x0080 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0080 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream r0 = r0.clientStream     // Catch:{ all -> 0x0080 }
                    io.grpc.internal.StatsTraceContext r0 = r0.statsTraceCtx     // Catch:{ all -> 0x0080 }
                    io.grpc.Status r4 = r7.clientNotifyStatus     // Catch:{ all -> 0x0080 }
                    r0.streamClosed(r4)     // Catch:{ all -> 0x0080 }
                    io.grpc.Status r0 = r7.clientNotifyStatus     // Catch:{ all -> 0x0080 }
                    io.grpc.Metadata r4 = r7.clientNotifyTrailers     // Catch:{ all -> 0x0080 }
                    io.grpc.SynchronizationContext r5 = r7.syncContext     // Catch:{ all -> 0x0080 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda2 r6 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda2     // Catch:{ all -> 0x0080 }
                    r6.<init>(r7, r0, r4)     // Catch:{ all -> 0x0080 }
                    r5.executeLater(r6)     // Catch:{ all -> 0x0080 }
                L_0x006d:
                    int r0 = r7.clientRequested     // Catch:{ all -> 0x0080 }
            ...
            public /* synthetic */ void m445lambda$clientRequested$1$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(StreamListener.MessageProducer producer) {
            ...
            public /* synthetic */ void m446lambda$clientRequested$2$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(Status notifyStatus, Metadata notifyTrailers) {
            ...
            public void writeMessage(java.io.InputStream r9) {
                /*
                    r8 = this;
                    monitor-enter(r8)
                    boolean r0 = r8.closed     // Catch:{ all -> 0x0062 }
                    if (r0 == 0) goto L_0x0007
                    monitor-exit(r8)     // Catch:{ all -> 0x0062 }
                    return
                L_0x0007:
                    io.grpc.internal.StatsTraceContext r0 = r8.statsTraceCtx     // Catch:{ all -> 0x0062 }
                    int r1 = r8.outboundSeqNo     // Catch:{ all -> 0x0062 }
                    r0.outboundMessage(r1)     // Catch:{ all -> 0x0062 }
                    io.grpc.internal.StatsTraceContext r2 = r8.statsTraceCtx     // Catch:{ all -> 0x0062 }
                    int r3 = r8.outboundSeqNo     // Catch:{ all -> 0x0062 }
                    r4 = -1
                    r6 = -1
                    r2.outboundMessageSent(r3, r4, r6)     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream r0 = r0.clientStream     // Catch:{ all -> 0x0062 }
                    io.grpc.internal.StatsTraceContext r0 = r0.statsTraceCtx     // Catch:{ all -> 0x0062 }
                    int r1 = r8.outboundSeqNo     // Catch:{ all -> 0x0062 }
                    r0.inboundMessage(r1)     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream r0 = r0.clientStream     // Catch:{ all -> 0x0062 }
                    io.grpc.internal.StatsTraceContext r1 = r0.statsTraceCtx     // Catch:{ all -> 0x0062 }
                    int r2 = r8.outboundSeqNo     // Catch:{ all -> 0x0062 }
                    r3 = -1
                    r5 = -1
                    r1.inboundMessageRead(r2, r3, r5)     // Catch:{ all -> 0x0062 }
                    int r0 = r8.outboundSeqNo     // Catch:{ all -> 0x0062 }
                    int r0 = r0 + 1
                    r8.outboundSeqNo = r0     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$SingleMessageProducer r0 = new io.grpc.inprocess.InProcessTransport$SingleMessageProducer     // Catch:{ all -> 0x0062 }
                    r1 = 0
                    r0.<init>(r9)     // Catch:{ all -> 0x0062 }
                    int r1 = r8.clientRequested     // Catch:{ all -> 0x0062 }
                    if (r1 <= 0) goto L_0x0056
                    int r1 = r1 + -1
                    r8.clientRequested = r1     // Catch:{ all -> 0x0062 }
                    io.grpc.SynchronizationContext r1 = r8.syncContext     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda0 r2 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda0     // Catch:{ all -> 0x0062 }
                    r2.<init>(r8, r0)     // Catch:{ all -> 0x0062 }
                    r1.executeLater(r2)     // Catch:{ all -> 0x0062 }
                    goto L_0x005b
                L_0x0056:
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r1 = r8.clientReceiveQueue     // Catch:{ all -> 0x0062 }
            ...
            public /* synthetic */ void m451lambda$writeMessage$3$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(StreamListener.MessageProducer producer) {
                this.clientStreamListener.messagesAvailable(producer);
            }
                ...
                if (InProcessTransport.this.clientMaxInboundMetadataSize == Integer.MAX_VALUE || (metadataSize = InProcessTransport.metadataSize(headers)) <= InProcessTransport.this.clientMaxInboundMetadataSize) {
                    synchronized (this) {
                        if (!this.closed) {
                            ...
                            this.syncContext.executeLater(new InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda5(this, headers));
                            this.syncContext.drain();
                            return;
                        }
                        return;
            ...
            public /* synthetic */ void m450lambda$writeHeaders$4$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(Metadata headers) {
            ...
            private void notifyClientClose(io.grpc.Status r4, io.grpc.Metadata r5) {
                ...
                L_0x0013:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda6 r2 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda6     // Catch:{ all -> 0x004f }
            ...
            public /* synthetic */ void m448lambda$notifyClientClose$5$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(Status clientStatus, Metadata trailers) {
                ...
                synchronized (this) {
                    ...
                    while (true) {
                        ...
                        if (poll != null) {
                            ...
                            this.syncContext.executeLater(new InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda4(this, clientStatus));
                            this.syncContext.drain();
                            return true;
                        }
                    }
            ...
            public /* synthetic */ void m447lambda$internalCancel$6$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(Status clientStatus) {
        ...
        private class InProcessClientStream implements ClientStream {
            ...
            public /* synthetic */ void m441lambda$request$0$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream() {
            ...
            public boolean serverRequested(int r7) {
                /*
                    r6 = this;
                    monitor-enter(r6)
                    boolean r0 = r6.closed     // Catch:{ all -> 0x0062 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0008
                    monitor-exit(r6)     // Catch:{ all -> 0x0062 }
                    return r1
                L_0x0008:
                    int r0 = r6.serverRequested     // Catch:{ all -> 0x0062 }
                    r2 = 1
                    if (r0 <= 0) goto L_0x000f
                    r3 = r2
                    goto L_0x0010
                ...
                L_0x0010:
                    int r0 = r0 + r7
                    r6.serverRequested = r0     // Catch:{ all -> 0x0062 }
                L_0x0013:
                    int r0 = r6.serverRequested     // Catch:{ all -> 0x0062 }
                    if (r0 <= 0) goto L_0x0037
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r0 = r6.serverReceiveQueue     // Catch:{ all -> 0x0062 }
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r0 = (io.grpc.internal.StreamListener.MessageProducer) r0     // Catch:{ all -> 0x0062 }
                    io.grpc.SynchronizationContext r4 = r6.syncContext     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda3 r5 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda3     // Catch:{ all -> 0x0062 }
                    r5.<init>(r6, r0)     // Catch:{ all -> 0x0062 }
                    r4.executeLater(r5)     // Catch:{ all -> 0x0062 }
                    goto L_0x0013
                L_0x0037:
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r0 = r6.serverReceiveQueue     // Catch:{ all -> 0x0062 }
                    boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0062 }
                    if (r0 == 0) goto L_0x004f
                    boolean r0 = r6.serverNotifyHalfClose     // Catch:{ all -> 0x0062 }
                    if (r0 == 0) goto L_0x004f
                    r6.serverNotifyHalfClose = r1     // Catch:{ all -> 0x0062 }
                    io.grpc.SynchronizationContext r0 = r6.syncContext     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda4 r4 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda4     // Catch:{ all -> 0x0062 }
                    r4.<init>(r6)     // Catch:{ all -> 0x0062 }
                    r0.executeLater(r4)     // Catch:{ all -> 0x0062 }
                L_0x004f:
                    int r0 = r6.serverRequested     // Catch:{ all -> 0x0062 }
            ...
            public /* synthetic */ void m442lambda$serverRequested$1$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream(StreamListener.MessageProducer producer) {
            ...
            public /* synthetic */ void m443lambda$serverRequested$2$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream() {
            ...
            public void writeMessage(java.io.InputStream r9) {
                ...
                L_0x0007:
                    ...
                    r2.outboundMessageSent(r3, r4, r6)     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessServerStream r0 = r0.serverStream     // Catch:{ all -> 0x0062 }
                    io.grpc.internal.StatsTraceContext r0 = r0.statsTraceCtx     // Catch:{ all -> 0x0062 }
                    int r1 = r8.outboundSeqNo     // Catch:{ all -> 0x0062 }
                    r0.inboundMessage(r1)     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0062 }
                    ...
                    r1 = 0
                    r0.<init>(r9)     // Catch:{ all -> 0x0062 }
                    int r1 = r8.serverRequested     // Catch:{ all -> 0x0062 }
                    if (r1 <= 0) goto L_0x0056
                    int r1 = r1 + -1
                    r8.serverRequested = r1     // Catch:{ all -> 0x0062 }
                    io.grpc.SynchronizationContext r1 = r8.syncContext     // Catch:{ all -> 0x0062 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda5 r2 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda5     // Catch:{ all -> 0x0062 }
                    r2.<init>(r8, r0)     // Catch:{ all -> 0x0062 }
                    r1.executeLater(r2)     // Catch:{ all -> 0x0062 }
                    goto L_0x005b
                L_0x0056:
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r1 = r8.serverReceiveQueue     // Catch:{ all -> 0x0062 }
                    r1.add(r0)     // Catch:{ all -> 0x0062 }
                L_0x005b:
                    monitor-exit(r8)     // Catch:{ all -> 0x0062 }
                    io.grpc.SynchronizationContext r0 = r8.syncContext
            ...
            public /* synthetic */ void m444lambda$writeMessage$3$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream(StreamListener.MessageProducer producer) {
                this.serverStreamListener.messagesAvailable(producer);
            }
                ...
                synchronized (this) {
                    ...
                    while (true) {
                        ...
                        if (poll != null) {
                            ...
                            this.syncContext.executeLater(new InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda1(this, serverListenerStatus));
                            this.syncContext.drain();
                            return true;
                        }
                    }
            ...
            public /* synthetic */ void m440lambda$internalCancel$4$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream(Status serverListenerStatus) {
            ...
            public void halfClose() {
                ...
                L_0x0007:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda2 r1 = new io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda2     // Catch:{ all -> 0x0024 }
            ...
            public /* synthetic */ void m439lambda$halfClose$5$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream() {
                this.serverStreamListener.halfClosed();
            }
