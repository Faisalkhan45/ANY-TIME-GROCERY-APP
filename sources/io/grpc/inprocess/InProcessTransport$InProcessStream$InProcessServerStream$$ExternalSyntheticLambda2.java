...
public final /* synthetic */ class InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ InProcessTransport$InProcessStream$InProcessServerStream$$ExternalSyntheticLambda2(InProcessTransport.InProcessStream.InProcessServerStream inProcessServerStream, Status status, Metadata metadata) {
    ...
    public final void run() {
        this.f$0.m446lambda$clientRequested$2$iogrpcinprocessInProcessTransport$InProcessStream$InProcessServerStream(this.f$1, this.f$2);
    }
}
