...
public final /* synthetic */ class InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ InProcessTransport$InProcessStream$InProcessClientStream$$ExternalSyntheticLambda4(InProcessTransport.InProcessStream.InProcessClientStream inProcessClientStream) {
        this.f$0 = inProcessClientStream;
    }

    public final void run() {
        this.f$0.m443lambda$serverRequested$2$iogrpcinprocessInProcessTransport$InProcessStream$InProcessClientStream();
    }
}
