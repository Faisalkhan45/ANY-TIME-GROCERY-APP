...
class OkHttpProtocolNegotiator {
    ...
    static final class AndroidNegotiator extends OkHttpProtocolNegotiator {
        ...
        public void configureTlsExtensions(javax.net.ssl.SSLSocket r11, java.lang.String r12, java.util.List<io.grpc.okhttp.internal.Protocol> r13) {
            /*
                r10 = this;
                java.lang.String[] r0 = io.grpc.okhttp.OkHttpProtocolNegotiator.protocolIds(r13)
            ...
            L_0x007f:
                ...
                java.util.logging.Logger r7 = io.grpc.okhttp.OkHttpProtocolNegotiator.logger     // Catch:{ IllegalAccessException -> 0x00f1, InvocationTargetException -> 0x00ea, InstantiationException -> 0x00e3 }
            ...
            L_0x00b3:
                ...
                byte[] r4 = io.grpc.okhttp.internal.Platform.concatLengthPrefixed(r13)
                r2[r3] = r4
